...
const FlvViewerProvider_1 = require("./FlvViewerProvider");
// This method is called when your extension is activated
// Your extension is activated the very first time the command is executed
function activate(context) {
    console.log('Congratulations, your extension "flv-tag-preview" is now active!');
    // Register our custom editor provider
    const provider = new FlvViewerProvider_1.FlvViewerProvider(context);
    context.subscriptions.push(vscode.window.registerCustomEditorProvider(FlvViewerProvider_1.FlvViewerProvider.viewType, provider, {
